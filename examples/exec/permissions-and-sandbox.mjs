...
// defaults to `sandboxMode: 'workspace-write'` + `approvalMode: 'never'` (a deprecation warning is logged).
await run('fullAuto (deprecated defaults: workspace-write + never)', { fullAuto: true });
