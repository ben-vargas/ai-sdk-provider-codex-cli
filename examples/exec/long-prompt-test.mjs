 ...
 *
 * Run: node examples/exec/long-prompt-test.mjs
 */
...
const USER_PROMPT = `Review the following sign-in page component and propose an improved version.
Current stack: Next.js + Tailwind CSS.
...
async function main() {
  ...
  try {
    ...
    const result = await generateText({
      model: codex('gpt-6-sol', { reasoningEffort: 'medium' }),
