...
| `basic-usage-gpt-5-codex.mjs`           | `examples/exec/basic-usage-gpt-5-codex.mjs`           | `examples/app-server/basic-usage-gpt-5-codex.mjs`           |
...
| `generate-object-basic-gpt-5-codex.mjs` | `examples/exec/generate-object-basic-gpt-5-codex.mjs` | `examples/app-server/generate-object-basic-gpt-5-codex.mjs` |
...
| `streaming-gpt-5-codex.mjs`             | `examples/exec/streaming-gpt-5-codex.mjs`             | `examples/app-server/streaming-gpt-5-codex.mjs`             |
