...
A community provider for Vercel AI SDK v6 that integrates OpenAI's Codex CLI with current GPT models such as `gpt-6-astra`, `gpt-5.6-sol`, and `gpt-5.5`, plus Codex-specific slugs like `gpt-5.3-codex-spark` and `gpt-5.2-codex`, using your ChatGPT Plus/Pro subscription.
...
| Provider Version | AI SDK Version | NPM Tag               | Status             | NPM Installation                                      |
| ---------------- | -------------- | --------------------- | ------------------ | ----------------------------------------------------- |
| 2.x.x            | v7             | `latest`, `ai-sdk-v7` | Active development | `npm i ai-sdk-provider-codex-cli ai@^7.0.0`           |
| 1.x.x            | v6             | `ai-sdk-v6`           | Maintenance        | `npm i ai-sdk-provider-codex-cli@ai-sdk-v6 ai@^6.0.0` |
| 0.x.x            | v5             | `ai-sdk-v5`           | Maintenance        | `npm i ai-sdk-provider-codex-cli@ai-sdk-v5 ai@^5.0.0` |

This README documents the **1.x / AI SDK v6** maintenance line (git branch `ai-sdk-v6`). For AI SDK v7 use the default `latest` package line documented on the `main` branch.

## Installation

### For AI SDK v6 (maintenance)
...
2. Install provider and AI SDK v6 (pin the `ai-sdk-v6` npm tag; `latest` is the AI SDK v7 line)

```bash
npm i ai@^6.0.0 ai-sdk-provider-codex-cli@ai-sdk-v6
```
